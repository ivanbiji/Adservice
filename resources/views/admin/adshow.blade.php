            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                    ...
                    <div class="container">
                        ...
                        <button type="link" onclick="window.location.href='{{ route('user') }}/view/{{ $seller->id }}'" class="btn btn-block btn-warning">View Seller</button>
                    </div>
                    <br>
                    <div class="container">
                    ...
                    <form id="logout-form-adshow" action="/adadmin/delete" method="POST" style="display: none;">
                        @csrf
